 ...
 *
 * Daftar ujian milik guru dengan ringkasan hasil
 */
...
$where = "WHERE u.created_by_role = 'guru' AND u.created_by_id = $guru_id AND u.status IN ('aktif','selesai')";
...
$global = $conn->query("SELECT
    ...
    WHERE u.created_by_role = 'guru' AND u.created_by_id = $guru_id AND u.status IN ('aktif','selesai')")->fetch_assoc();
...
<div class="content-with-sidebar">
    ...
    <div class="content-area">
        <div class="page-header">
            <div>
                <h4><i class="fas fa-chart-pie me-2"></i>Laporan Ujian Saya</h4>
                <nav>
                    <ol class="breadcrumb">
            ...
            <div class="card-body py-3">
                <form method="GET" class="row g-2 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="<?= base_url('guru/laporan/index.php') ?>" class="btn btn-sm btn-secondary"><i class="fas fa-times"></i></a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('guru/laporan/detail_ujian.php?id=' . $u['id']) ?>" class="btn btn-sm btn-primary" title="Detail"><i class="fas fa-eye me-1"></i>Detail</a>
                                    <div class="btn-group btn-group-sm ms-1">
                                        <a href="<?= base_url('guru/laporan/export_excel.php?id=' . $u['id']) ?>" class="btn btn-success" title="Excel"><i class="fas fa-file-excel"></i></a>
                                        <a href="<?= base_url('guru/laporan/export_pdf.php?id=' . $u['id']) ?>" class="btn btn-danger" title="PDF" target="_blank"><i class="fas fa-file-pdf"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                ...
                <div class="empty-state">
                    ...
                    <p>Belum ada ujian dengan hasil.<?= $filter_status || $search ? ' Coba ubah filter.' : '' ?></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
