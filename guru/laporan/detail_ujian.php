            ...
            <div>
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('guru/laporan/index.php') ?>">Laporan</a></li>
                        <li class="breadcrumb-item active">Detail</li>
                    </ol>
                </nav>
            </div>
            <div class="btn-group">
                <a href="<?= base_url('guru/laporan/export_excel.php?id=' . $id) ?>" class="btn btn-success"><i class="fas fa-file-excel me-1"></i>Excel</a>
                <a href="<?= base_url('guru/laporan/export_pdf.php?id=' . $id) ?>" class="btn btn-danger" target="_blank"><i class="fas fa-file-pdf me-1"></i>PDF</a>
            </div>
        </div>
