        ...
        if ($jumlah_soal > $total_available) {
            ...
            try {
                ...
                $stmt->bind_param("issssiiissi",
                    ...
                    $jumlah_soal, $alokasi_waktu, $acak_soal, $acak_jawaban, $role, $guru_id);
                $stmt->execute();
                ...
                $conn->commit();
                redirect(base_url('guru/ujian/edit.php?id=' . $ujian_id . '&tab=kunci'), 'success',
...
<div class="content-with-sidebar">
    ...
    <div class="content-area">
        ...
        <div class="alert alert-warning">
            <i class="fas fa-info-circle me-2"></i>Anda belum punya bank soal dengan soal. <a href="<?= base_url('guru/bank_soal/buat.php') ?>">Buat bank soal dulu</a>.
        </div>
        <?php else: ?>
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" name="tanggal_ujian" class="form-control" required value="<?= e($_POST['tanggal_ujian'] ?? date('Y-m-d')) ?>">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Jam Mulai <span class="text-danger">*</span></label>
                                    <input type="time" name="jam_mulai" class="form-control" required value="<?= e($_POST['jam_mulai'] ?? '08:00') ?>">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Jam Selesai <span class="text-danger">*</span></label>
                                    <input type="time" name="jam_selesai" class="form-control" required value="<?= e($_POST['jam_selesai'] ?? '10:00') ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="jumlah_soal" id="jumlahSoal" class="form-control" min="1" required value="<?= e($_POST['jumlah_soal'] ?? '') ?>">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="alokasi_waktu" class="form-control" min="5" required value="<?= e($_POST['alokasi_waktu'] ?? '60') ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" name="acak_soal" <?= ($_POST['acak_soal'] ?? '') ? 'checked' : '' ?>>
                                        <label class="form-check-label">Acak urutan soal per siswa</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check form-switch mb-2">
                                        <input class="form-check-input" type="checkbox" name="acak_jawaban" <?= ($_POST['acak_jawaban'] ?? '') ? 'checked' : '' ?>>
                                        <label class="form-check-label">Acak urutan jawaban per siswa</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="kelas<?= $k['id'] ?>">
                                            <?= e($k['nama_kelas']) ?> <small class="text-muted">(<?= $k['jumlah_siswa'] ?> siswa)</small>
                                        </label>
                                    </div>
                                </div>
                                <?php endwhile; ?>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-save me-1"></i>Simpan & Atur Kunci</button>
