    ...
    if (empty($kode_soal) || empty($nama_bank)) {
        ...
        if ($stmt->get_result()->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                redirect(base_url('guru/soal/index.php?bank_id=' . $new_id), 'success',
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <div class="form-text">Format: MAPEL.KELAS.NOMOR (contoh: MAT.IX.001)</div>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?= base_url('guru/bank_soal/index.php') ?>" class="btn btn-secondary">
