...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($kode_soal) || empty($nama_bank)) {
        ...
        if ($stmt->get_result()->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                redirect(base_url('guru/bank_soal/index.php'), 'success', 'Bank soal berhasil diupdate.');
            } else {
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="<?= base_url('guru/soal/index.php?bank_id=' . $id) ?>" class="btn btn-info"><i class="fas fa-list me-1"></i>Kelola Soal</a>
                                <a href="<?= base_url('guru/bank_soal/index.php') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i>Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
