...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama_kelas)) {
        ...
        $stmt = $conn->prepare("SELECT id FROM kelas WHERE nama_kelas = ? AND id != ?");
        ...
        if ($stmt->get_result()->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                redirect(base_url('admin/kelas/index.php'), 'success', 'Kelas berhasil diupdate.');
            } else {
...
<div class="content-with-sidebar">
    ...
    <div class="content-area">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">Edit Kelas: <?= e($kelas['nama_kelas']) ?></div>
                    <div class="card-body">
                        <?php if ($error): ?>
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_kelas" class="form-control" required
                                       value="<?= e($_POST['nama_kelas'] ?? $kelas['nama_kelas']) ?>" autofocus>
                            </div>
