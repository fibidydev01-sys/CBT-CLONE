    ...
    <div class="content-area">
        <div class="page-header">
            ...
            <div>
                ...
                <a href="<?= base_url('admin/ujian/aktifkan.php?id=' . $id . '&action=selesai') ?>" class="btn btn-sm btn-danger ms-2" data-confirm="Akhiri ujian ini?">
