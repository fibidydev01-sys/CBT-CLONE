...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama) || empty($username) || empty($password)) {
        ...
        if ($duplicate) {
            ...
            $stmt = $conn->prepare("INSERT INTO pengawas (nama, username, password) VALUES (?, ?, ?)");
            $stmt->bind_param("sss", $nama, $username, $hashed);

            if ($stmt->execute()) {
                redirect(base_url('admin/pengawas/index.php'), 'success', 'Pengawas "' . $nama . '" berhasil ditambahkan.');
            } else {
                $error = 'Gagal menambahkan pengawas.';
            }
            $stmt->close();
        }
    }
...
<div class="content-with-sidebar">
    ...
    <div class="content-area">
        <div class="page-header">
            <div>
                <h4><i class="fas fa-plus me-2"></i>Tambah Pengawas</h4>
                <nav>
                    <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header">Form Tambah Pengawas</div>
                    <div class="card-body">
                        <?php if ($error): ?>
